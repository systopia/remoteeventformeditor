...
// Make CRM_Remoteeventformeditor_ExtensionUtil available.
require_once __DIR__ . '/../../remoteeventformeditor.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('remoteeventformeditor');
 ...
 */
function _remoteeventformeditor_test_civicrm_container(ContainerBuilder $container): void {
}
